...
| `test_elements.py` | 34 | ④ 빌더 (요소) | `Block` → `<hp:p>` / `<hp:tbl>` / `<hp:pic>` XML 생성 |
...
### ④ 빌더 — `test_header.py` + `test_elements.py` + `test_bindata.py` + `test_manifest.py` (3 + 34 + 10 + 8 = 55개)
